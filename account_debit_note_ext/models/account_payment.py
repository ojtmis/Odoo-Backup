        ...
        for rec in self:
            ...
            if not rec.name:
                ...
                if rec.payment_type == 'transfer':
                    ...
                    if rec.partner_type == 'customer':
                        if rec.payment_type == 'inbound':
                            if rec.invoice_ids.is_debit_note:
                                sequence_code = 'account.payment.customer.debit'
                            else:
                ...
                if not rec.name and rec.payment_type != 'transfer':
                    raise UserError(_("You have to define a sequence for %s in your company.").format(sequence_code,))
