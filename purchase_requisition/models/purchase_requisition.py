...
class PurchaseRequisition(models.Model):
    ...
    notes_here = fields.Text(string='Remarks')
    ...
    def _prepare_tender_values(self, product_id, product_qty, product_uom, location_id, name, origin, company_id,
                               values):
        return {
            'origin': origin,
...
class PurchaseRequisitionLine(models.Model):
    ...
    requisition_id = fields.Many2one('purchase.requisition', required=True, string='Purchase Agreemen t',
                                     ondelete='cascade')
