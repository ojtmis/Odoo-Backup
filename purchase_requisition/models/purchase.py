...
class PurchaseOrder(models.Model):
    ...
    # new
    justification = fields.Text(related='requisition_id.justification', string='Justification')
    notes_here = fields.Text(related='requisition_id.notes_here', string='Remarks')
    # end
